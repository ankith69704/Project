...
// @route     POST /api/v1/auth/family
// @access    Private
exports.addMyFamilyMember = asyncHandler(async (req, res, next) => {
  ...
  if (role === 'Partner') {
    member.partner = familyMember._id;
  } else if (role === 'Child') {
    member.children.push(familyMember._id);
  }
